...
def print_stats(trial_id, dl):
    wrist_device, _, true_device = dl.load_oxygen(trial_id)
...
def visualize_classifier_results(training_ids, test_id, dl):
    ...
    wrist_oxygen, wrist_oxygen_clean, true_oxygen = dl.load_oxygen(trial_id, y_pred=y_pred)
