...
def run_experiments(clf, trial_ids, data_loader, data_name='all'):
    ...
    plt.savefig(CM_CACHE + 'cm-' + str(data_loader) + '-' + data_name + '.png')
    plt.show()
...
def run_all():
    ...
    for t in [1.0, 2.0, 3.0]:
        ...
        run_experiments(clf, trial_ids, dl, data_name='dark')
